...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=fqAF0QjD#19YeSsFStlCA3moExpzW-4WkdnN8xyM-YbccmRhG3-I' : process.env.SESSION_ID,
...
OWNER: proces.env.OWNER === undefined ? "16132197256" : process.env.OWNER};
